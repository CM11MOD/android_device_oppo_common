...
public class Utils {
    ...
    private static final String TAG = "DeviceHandler_Utils";
    private static final String TAG_READ = "DeviceHandler_Utils_Read";
    private static final String TAG_WRITE = "DeviceHandler_Utils_Write";
